...
import com.alicangunes.javamaps.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerLauncher();
        sharedPreferences = MapsActivity.this.getSharedPreferences("com.alicangunes.javamaps;", MODE_PRIVATE);
        info = false;
    ...
    public void save(View view) {
        ...
        //therading -> Main (UI), Default (CPU Intensive), IO (network, database)
